...
print(f'Accuracy on FGSM adversarial examples after CutMIx - High Confidence postprocessing: {accuracy:.2f}%')

import time
start_time = time.time()

"""#pgd with cutmix and High Confidence"""
...
print(f'Accuracy on PGD adversarial examples after CutMIx - High Confidence postprocessing: {accuracy:.2f}%')
