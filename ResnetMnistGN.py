...
"""# FAST GRADIENT SIGN METHOD WITH GN"""
...
for images, labels in test_loader:
    ...
    # Periodically save checkpoints (e.g., every 100 batches)
...
accuracy_fgsm_noised = total_correct / total_examples
print(f"Accuracy on FGSM adversarial examples after applying Gaussian Noise: {accuracy_fgsm_noised * 100:.2f}%")
...
print(f"Accuracy on PGD adversarial examples over the entire test set after gaussian: {accuracy_pgd * 100:.2f}%")
