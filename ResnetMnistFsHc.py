...
accuracy = compute_accuracy_with_high_confidence_on_fgsm(model, test_loader, device)
print(f'Accuracy on FGSM adversarial examples after Feature Squeezing - High Confidence postprocessing: {accuracy:.2f}%')

import time
start_time = time.time()

"""#pgd with FS and High Confidence"""
...
accuracy = compute_accuracy_with_high_confidence_on_pgd(model, test_loader, device)
print(f'Accuracy on PGD adversarial examples after Feature Squeezing - High Confidence postprocessing: {accuracy:.2f}%')
