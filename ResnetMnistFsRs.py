...
print(f'Accuracy on FGSM adversarial examples after Feature Squeezing -Reverse Sigmoid postprocessing: {accuracy:.2f}%')
...
print(f'Accuracy on PGD adversarial examples after Feature Squeezing - Reverse Sigmoid postprocessing: {accuracy:.2f}%')
